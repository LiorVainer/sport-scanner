...
export const FixturePriceRangeSchema = z
    .object({
        ...
        min: z.number().describe(`Minimum estimated ticket price`),
        max: z.number().describe(`Maximum estimated ticket price`),
    })
...
export const FixturePriceRangeListSchema = z
    ...
    .describe(`An array of price range objects, each with fixture ID, min and max price`);
